"""An abstract class that defines the web component interface for Workbench"""
...
class ComponentInterface(ABC):
    ...
    def update_properties(self, data_object: WorkbenchObject) -> list:
        """Update the properties of the component/container

        Args:
            data_object (workbench_object/dataframe): A Workbench object or DataFrame
