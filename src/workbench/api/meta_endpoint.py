...
If any child endpoint in the DAG is async (e.g. ``smiles-to-3d-v2``),
...
if __name__ == "__main__":
    ...
    sample_dag.add_endpoint("smiles-to-3d-v2")
    sample_dag.add_aggregation(Concat(name="combine"))
    sample_dag.add_edge("smiles-to-2d-v1", "combine")
    sample_dag.add_edge("smiles-to-3d-v2", "combine")
    sample_dag.set_input_node("smiles-to-2d-v1", "smiles-to-3d-v2")
