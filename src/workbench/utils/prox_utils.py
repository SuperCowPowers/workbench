...
def target_intervals(pred_df, prox_df, id_column: str, target: str, distance_threshold=3.0) -> pd.DataFrame:
    ...
    target_bounds = close_neighbors.groupby(id_column).agg(
...
if __name__ == "__main__":
    ...
    show = ["id", "solubility", "prediction", "target_min", "target_max", "target_mean", "target_std", "pred_delta", "pred_interval", "confidence"]
