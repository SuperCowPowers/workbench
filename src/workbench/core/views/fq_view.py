"""FQView Class: A View that computes various FeatureSet quality metrics"""
...
class FQView:
    ...
    Common Usage:
        ...
        mdq_view = FQView.create(fs, endpoint=endpoint, id_column="id")
...
if __name__ == "__main__":
    """Exercise the FQView functionality"""
    ...
    # Create a FQView
    mdq_view = FQView.create(my_fs, endpoint=my_endpoint, id_column="id")
