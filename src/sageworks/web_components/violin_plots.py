...
def create_figure(df: pd.DataFrame, figure_args: dict, max_plots: int) -> plotly.graph_objs.Figure:
...
def create(
    ...
    return dcc.Graph(id=component_id, figure=create_figure(df, figure_args, max_plots))
