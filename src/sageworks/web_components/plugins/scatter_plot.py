...
class ScatterPlot(PluginInterface):
    ...
    def update_properties(self, input_data: Union[DataSource, FeatureSet, pd.DataFrame], **kwargs) -> list:
        ...
        if isinstance(input_data, DataSource) or isinstance(input_data, FeatureSet):
        ...
        # Define a color scale for the nodes (green, yellow, orange, red)
        color_scale = [
            [0.0, "rgb(64,64,160)"],
            [0.33, "rgb(48, 140, 140)"],
            [0.67, "rgb(140, 140, 48)"],
