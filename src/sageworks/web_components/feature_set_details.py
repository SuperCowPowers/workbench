"""A Component for details/information about FeatureSets"""
from dash import dcc


def create_markdown(feature_set_details: dict) -> str:
    """Create the Markdown for the details/information about the FeatureSet
    Args:
        feature_set_details (dict): A dictionary of information about the feature set
    Returns:
    ...
    **Rows:** <<num_rows>>  **Columns:** <<num_columns>>
    ...
    details_markdown = ""
    for column_name, value_counts in feature_set_details["value_counts"].items():
        bullet_list = ""
...
def create(component_id: str, feature_set_details: dict) -> dcc.Markdown:
    """Create a Markdown Component details/information about the FeatureSet
    Args:
        component_id (str): The ID of the UI component
        feature_set_details (dict): A dictionary of column information
    Returns:
        dcc.Markdown: A Dash Markdown Component
    """

    # Generate a figure and wrap it in a Dash Graph Component
    return dcc.Markdown(id=component_id, children=create_markdown(feature_set_details), dangerously_allow_html=True)
