"""DashboardMetrics is a utility class that fetches metrics for the SageWorks Dashbaord."""
...
class DashboardMetrics:
    def __init__(self):
        ...
        - NetworkTx: The number of bytes transmitted from the instance.
        - NetworkRx: The number of bytes received by the instance.
        - HTTPCode_ELB_5XX_Count: The number of 5XX errors generated by the load balancer.
        ...
        self.stats = ["Average", "Average", "Sum", "Sum", "Sum", "Sum"]
    ...
    def get_metric_data_queries(self, service_name: str) -> list[dict]:
                ...
                "MetricStat": {
                    "Metric": {
                        ...
                        "Dimensions": [
                            ...
                            {"Name": "ClusterName", "Value": "SageWorksCluster"},
                        ],
                    },
                    "Period": period,
                    "Stat": stat,
    ...
    def get_metrics(self, service_name: str, days_back: int = 3) -> pd.DataFrame:
        ...
        """
        # Fetch the metrics
        response = self._fetch_metrics(service_name=service_name, days_back=days_back)
    ...
    def _fetch_metrics(self, service_name: str, days_back: int):
        """Internal Method: Fetch metrics from CloudWatch"""
        start_time_str, end_time_str = self.get_time_range(days_back=days_back)
        metric_data_queries = self.get_metric_data_queries(service_name=service_name)
...
if __name__ == "__main__":
    ...
    metrics_data = my_metrics.get_metrics(service_name="SageworksService", days_back=3)
    pprint(metrics_data)
