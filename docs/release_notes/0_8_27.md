...
### Minor Improvments
The model scripts used in deployed AWS Endpoints are now case-insenstive. In general this should make the use of the endpoints a bit more flexible for End-User Applications to hit the endpoints with less pre-processing of their column names.
