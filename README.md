...
and most API users don't need them. See [Installation extras](#installation-extras)
...
Cleanlab/Datalab workflows are optional and not bundled in any extra. Install
...
captured) generated by `ci/lock.sh` (via [uv](https://github.com/astral-sh/uv)).
