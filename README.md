...
- [Deploying Chemprop Models](src/workbench/examples/models/chemprop_open_admet.py)
- [Deploying Foundation Chemprop Models](src/workbench/examples/models/chemprop_foundation.py)
