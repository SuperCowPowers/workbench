...
model_list = [
    ...
    "caco2-efflux-reg-chemprop-desc",
    "caco2-papp-a-b-reg-xgb",
    "caco2-papp-a-b-reg-pytorch",
    "caco2-papp-a-b-reg-chemprop",
    "caco2-papp-a-b-reg-chemprop-desc",
    "hlm-clint-reg-xgb",
    "hlm-clint-reg-pytorch",
    "hlm-clint-reg-chemprop",
    "hlm-clint-reg-chemprop-desc",
    "ksol-reg-xgb",
    "ksol-reg-pytorch",
    "ksol-reg-chemprop",
    "ksol-reg-chemprop-desc",
    "logd-reg-xgb",
    "logd-reg-pytorch",
    "logd-reg-chemprop",
    "logd-reg-chemprop-desc",
    "mbpb-reg-xgb",
    "mbpb-reg-pytorch",
    "mbpb-reg-chemprop",
    "mbpb-reg-chemprop-desc",
    "mgmb-reg-xgb",
    "mgmb-reg-pytorch",
    "mgmb-reg-chemprop",
    "mgmb-reg-chemprop-desc",
    "mlm-clint-reg-xgb",
    "mlm-clint-reg-pytorch",
    "mlm-clint-reg-chemprop",
    "mlm-clint-reg-chemprop-desc",
    "mppb-reg-xgb",
    "mppb-reg-pytorch",
    "mppb-reg-chemprop",
    "mppb-reg-chemprop-desc",
]
