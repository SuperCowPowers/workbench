...
to_model = FeaturesToModel(
    fs_name, "smiles-to-taut-md-stereo-v1", model_type=ModelType.TRANSFORMER, custom_script=my_script_path
)
...
my_model = Model("smiles-to-taut-md-stereo-v1")
endpoint = my_model.to_endpoint(name="smiles-to-taut-md-stereo-v1", tags=["smiles", "molecular descriptors"])
