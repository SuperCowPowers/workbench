import os
from aws_cdk import Stack, aws_ecs as ecs, aws_ec2 as ec2, aws_iam as iam, aws_elasticache as elasticache
...
class SageworksDashboardStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        container = task_definition.add_container(
            ...
            memory_limit_mib=4096,
            environment={"REDIS_HOST": redis_endpoint, "SAGEWORKS_BUCKET": sageworks_bucket},
        )
