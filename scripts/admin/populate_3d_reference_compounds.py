...
REFERENCE_COMPOUNDS = [
    ...
    {
        "name": "benzene", "smiles": "c1ccccc1", "shape_class": "disc",
        "npr1_min": 0.40, "npr1_max": 0.60,
        "npr2_min": 0.40, "npr2_max": 0.60,
        "imhb_min": 0.0,  "imhb_max": 0.0,
        "axis_min": 2.4,  "axis_max": 3.2,
    ...
    {
        "name": "naphthalene", "smiles": "c1ccc2ccccc2c1", "shape_class": "disc",
        "npr1_min": 0.20, "npr1_max": 0.45,
        "npr2_min": 0.55, "npr2_max": 0.80,
        "imhb_min": 0.0,  "imhb_max": 0.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Planar bicyclic aromatic, elongated — off-corner disc",
    },
    {
        "name": "anthracene", "smiles": "c1ccc2cc3ccccc3cc2c1", "shape_class": "disc",
        "npr1_min": 0.10, "npr1_max": 0.30,
        "npr2_min": 0.70, "npr2_max": 0.90,
        "imhb_min": 0.0,  "imhb_max": 0.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Three-ring linear acene — stretches NPR range further toward rod-like",
    },
    {
        "name": "decane", "smiles": "CCCCCCCCCC", "shape_class": "rod",
        "npr1_min": 0.00, "npr1_max": 0.25,
        "npr2_min": 0.80, "npr2_max": 1.01,
        "imhb_min": 0.0,  "imhb_max": 0.0,
        "axis_min": 9.5,  "axis_max": 13.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Extended all-trans alkane chain — textbook rod shape",
    },
    {
        "name": "adamantane", "smiles": "C1C2CC3CC1CC(C2)C3", "shape_class": "sphere",
        "npr1_min": 0.90, "npr1_max": 1.01,
        "npr2_min": 0.90, "npr2_max": 1.01,
        "imhb_min": 0.0,  "imhb_max": 0.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "T_d-symmetric diamondoid cage — textbook sphere shape",
    },
    {
        "name": "biphenyl", "smiles": "c1ccc(-c2ccccc2)cc1", "shape_class": "",
        "imhb_min": 0.0, "imhb_max": 0.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    {
        "name": "salicylic_acid", "smiles": "O=C(O)c1ccccc1O", "shape_class": "",
        "imhb_min": 0.3, "imhb_max": 3.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Canonical IMHB former: ortho-OH donates to COOH carbonyl",
    },
    {
        "name": "2_hydroxybenzaldehyde", "smiles": "O=Cc1ccccc1O", "shape_class": "",
        "imhb_min": 0.3, "imhb_max": 3.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    {
        "name": "ethylenediamine", "smiles": "NCCN", "shape_class": "",
        "nitrogen_span_min": 2.8, "nitrogen_span_max": 4.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "H2N-CH2-CH2-NH2, 4-bond N-to-N — short aliphatic diamine",
    },
    {
        "name": "p_phenylenediamine", "smiles": "Nc1ccc(N)cc1", "shape_class": "",
        "nitrogen_span_min": 5.3, "nitrogen_span_max": 6.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    {
        "name": "pyridine", "smiles": "c1ccncc1", "shape_class": "",
        "imhb_min": 0.0, "imhb_max": 0.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    {
        "name": "fluorobenzene", "smiles": "Fc1ccccc1", "shape_class": "",
        "imhb_min": 0.0, "imhb_max": 0.0,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    {
        "name": "l_alanine", "smiles": "N[C@@H](C)C(=O)O", "shape_class": "",
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Smallest chiral reference — tests stereo preservation round-trip",
    },
    {
        "name": "s_ibuprofen", "smiles": "CC(C)Cc1ccc([C@H](C)C(=O)O)cc1", "shape_class": "",
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Real drug with explicit stereo — tests stereo preservation on larger molecule",
    },
    {
        "name": "cis_stilbene", "smiles": "C(=C\\c1ccccc1)\\c1ccccc1", "shape_class": "",
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    {
        "name": "ethanol", "smiles": "CCO", "shape_class": "",
        "imhb_min": 0.0, "imhb_max": 0.0,
        "axis_min": 1.8, "axis_max": 3.5,
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Smallest drug-like molecule with a polar group",
    },
    {
        "name": "caffeine", "smiles": "CN1C=NC2=C1C(=O)N(C(=O)N2C)C", "shape_class": "",
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
        "notes": "Rigid planar drug — general sanity check",
    },
    {
        "name": "aspirin", "smiles": "CC(=O)Oc1ccccc1C(=O)O", "shape_class": "",
        "undefined_chiral_centers_expected": 0, "stereo_preserved_expected": True,
    ...
    },
    {
        ...
        "shape_class": "",
        "undefined_chiral_centers_expected": 6, "stereo_preserved_expected": True,
...
COLUMN_ORDER = [
    "id", "name", "smiles", "shape_class",
    "npr1_min", "npr1_max",
    "npr2_min", "npr2_max",
    "imhb_min", "imhb_max",
    "axis_min", "axis_max",
    "nitrogen_span_min", "nitrogen_span_max",
