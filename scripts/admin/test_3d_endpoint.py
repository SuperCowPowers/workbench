...
to the deployed smiles-to-3d-fast-v1 endpoint and validates the response.
...
Usage:
    ...
    python scripts/admin/test_3d_endpoint.py smiles-to-3d-fast-v2
"""
...
DEFAULT_ENDPOINT = "smiles-to-3d-fast-v1"
