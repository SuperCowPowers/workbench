...
old_error_smiles_1 = (
    "CCC1C2=N3C(=CC4=C(C(C)=O)C(C)=C5C=C6C(C)C(CCC(=O)O)"
    "C7=N6[Pd+2]3([N-]54)[N-]3C(=C2)C(C)=C(C(=O)NCCS(=O)(=O)O)C3=C7CC(=O)OC)C1C"
)
old_error_smiles_2 = (
    "O=C(CCC1C(=O)[O-][Gd+3]23456[O-]C(=O)C(CCC(=O)NCC(O)CO)"
    "N27CCN13CCN4(CC1=N5C(=CC=C1)C7)C(CCC(=O)NCC(O)CO)C(=O)[O-]6)NCC(O)CO"
)
