...
def update_last_updated(app: Dash, sageworks_artifacts: ArtifactsSummary):
    @app.callback(Output("last-updated-data-sources", "children"), Input("interval-component", "n_intervals"))
    def time_updated(n):
        global all_data
...
def update_data_source_table(app: Dash):
    @app.callback(Output("DATA_SOURCES_DETAILS", "data"), Input("interval-component", "n_intervals"))
